class Solution {
    // O(NlogN + N) O(2N)
    /*
    Sort based on positon
    Start from last, see if current car can catchup with the car ahead, before they reach end
    if it can't increase no of car fleets
    also keep updating the speed of the car ahead at each point
    */
